...
public abstract class PDFNetSample {
    ...
    protected void setTitle(int resId) {
        this.mTitle = PDFNetSDKSampleApplication.getInstance().getString(resId);
    }
    ...
    protected void setDescription(int resId) {
        this.mDescription = PDFNetSDKSampleApplication.getInstance().getString(resId);
    }
    ...
    protected void printHeader(OutputListener outputListener) {
        String header = PDFNetSDKSampleApplication.getInstance().getString(R.string.str_running_sample_header, this.mTitle);
        outputListener.println(header + "\n");
    }
    
    protected void printFooter(OutputListener outputListener) {
        String footer = PDFNetSDKSampleApplication.getInstance().getString(R.string.str_running_sample_footer);
