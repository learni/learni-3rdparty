...
import com.pdftron.android.pdfnetsdksamples.PDFNetSDKSampleApplication;
...
public class Utils {
    ...
    public static InputStream getAssetInputStream(String filePath) {
        try {
            return PDFNetSDKSampleApplication.getInstance().getAssets().open(filePath);
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public static File getAssetTempFile(String filePath) {
        File file = null;
        try {
            file = new File(PDFNetSDKSampleApplication.getInstance().getCacheDir(), FilenameUtils.getName(filePath));
    ...
    public static File createExternalFile(String fileName) {
        return new File(PDFNetSDKSampleApplication.getInstance().getExternalFilesDir(null), fileName);
    }
    ...
    public static String getExternalFilesDirPath() {
        return PDFNetSDKSampleApplication.getInstance().getExternalFilesDir(null).getAbsolutePath();
    }
