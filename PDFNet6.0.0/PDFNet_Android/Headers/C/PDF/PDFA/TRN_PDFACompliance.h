...
#ifndef	  PDFTRON_H_CPDFPDFA
#define	  PDFTRON_H_CPDFPDFA
...
TRN_API TRN_PDFAComplianceCreateFromFile(TRN_Bool convert, const TRN_UString file_path, const char* password, enum TRN_PDFAConformance conf, enum TRN_PDFAErrorCode* exceptions, int exlength, int max_ref_objs, TRN_Bool first_stop, TRN_PDFACompliance* result);
TRN_API TRN_PDFAComplianceCreateFromBuffer(TRN_Bool convert, const char* buf, int buf_size, const char* password, enum TRN_PDFAConformance conf, enum TRN_PDFAErrorCode* exceptions, int exlength, int max_ref_objs, TRN_Bool first_stop, TRN_PDFACompliance* result);
...
TRN_API TRN_PDFAComplianceGetError(TRN_PDFACompliance pdfac, int idx, enum TRN_PDFAErrorCode* result);
TRN_API TRN_PDFAComplianceGetRefObjCount(TRN_PDFACompliance pdfac, enum TRN_PDFAErrorCode id, int* result);
TRN_API TRN_PDFAComplianceGetRefObj(TRN_PDFACompliance pdfac, enum TRN_PDFAErrorCode id, int obj_idx, int* result);
TRN_API TRN_PDFAComplianceGetPDFAErrorMessage(enum TRN_PDFAErrorCode id, const char** result);
TRN_API TRN_PDFAComplianceSaveAsFromFileName(TRN_PDFACompliance pdfac, TRN_UString file_path, TRN_Bool linearized);
TRN_API TRN_PDFAComplianceSaveAsFromBuffer(TRN_PDFACompliance pdfac, TRN_Size* out_buf_size, const char** result_buf, TRN_Bool linearized);

#ifdef __cplusplus
}
#endif

#endif  // PDFTRON_H_CPDFPDFA
