...
#ifdef _WIN32
TRN_API TRN_FontCreateCIDTrueTypeFont2(TRN_SDFDoc doc , const void* logfont,
									   TRN_Bool embed, TRN_Bool subset, enum TRN_FontEncoding encoding, TRN_Font* result);
#endif



TRN_API TRN_FontCreateType1Font(TRN_SDFDoc doc , TRN_UString type,
...
TRN_API TRN_FontGetGlyphPath(TRN_Font font, TRN_UInt32 char_code,
							 TRN_UChar* oprs, double* data,  
							 int* res_oprs_sz, int* res_data_sz,
