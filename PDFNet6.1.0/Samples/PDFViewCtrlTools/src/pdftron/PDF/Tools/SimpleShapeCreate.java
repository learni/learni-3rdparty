...
abstract class SimpleShapeCreate extends Tool {
    ...
    public boolean onDown(MotionEvent e) {
        ...
        mDownPageNum = mPDFView.getPageNumberFromScreenPt(e.getX(), e.getY());
        if (mDownPageNum < 1) {
    ...
    protected pdftron.PDF.Rect getShapeBBox() {
        ...
        double [] pts1;
        double [] pts2;
        pts1 = mPDFView.convScreenPtToPagePt(mPt1.x - mPDFView.getScrollX(), mPt1.y - mPDFView.getScrollY(), mDownPageNum);
        pts2 = mPDFView.convScreenPtToPagePt(mPt2.x - mPDFView.getScrollX(), mPt2.y - mPDFView.getScrollY(), mDownPageNum);
