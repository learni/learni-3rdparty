 ...
 * viewed in a {@link SampleDetailFragment}.
 * <p>
...
public class SampleListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<PDFNetSample> adapter = new ArrayAdapter<PDFNetSample>(getActivity(), 
                android.R.layout.simple_list_item_activated_1, 
                android.R.id.text1, 
                MiscellaneousSamplesApplication.getInstance().getContent());
