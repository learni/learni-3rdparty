...
TRN_API TRN_PageSetCreateFilteredRange(TRN_PageSet* result, int range_start, int range_end, enum TRN_PagesFilter filter);
...
TRN_API TRN_PageSetAddFilteredRange(TRN_PageSet page_set, int range_start, int range_end, enum TRN_PagesFilter filter);
