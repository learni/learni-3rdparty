...
{
	TRN_Obj result;
	Convert::SetFlattenContentImpl(m_obj, flatten, &result);
}

inline void Convert::SVGOutputOptions::SetFlattenThreshold(enum FlattenThresholdFlag threshold)
{
	TRN_Obj result;
	Convert::SetFlattenThresholdImpl(m_obj, threshold, &result);
}
...
inline void Convert::SetFlattenContentImpl(TRN_Obj obj, enum FlattenFlag flatten, TRN_Obj* result)
{
	switch (flatten)
	{
		case e_off:
...
inline void Convert::SetFlattenThresholdImpl(TRN_Obj obj, enum FlattenThresholdFlag threshold, TRN_Obj* result)
{
	switch (threshold)
	{
		case e_very_strict:
