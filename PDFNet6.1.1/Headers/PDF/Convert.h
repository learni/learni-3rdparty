...
private:
	Convert ();
	~Convert ();
	static void SetFlattenContentImpl(TRN_Obj obj, enum FlattenFlag flatten, TRN_Obj* result);
	static void SetFlattenThresholdImpl(TRN_Obj obj, enum FlattenThresholdFlag threshold, TRN_Obj* result);
};
