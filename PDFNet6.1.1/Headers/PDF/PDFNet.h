...
public:
	...
	*/
	...
	enum CloudErrorCode
	 {
		STATUS_ERR,					///<Unexpected error. If the error persists contact pdftron support support@pdftron.com
		STATUS_OK,					///<Credentials are correct.
	    STATUS_NETWORK_ERR,			///<Can’t establish a connection due networking error; Check your connectivity to the internet and firewall settings.
	    STATUS_BAD_CREDENTIALS,		///<Credentials provided for authentication are incorrect. Make sure you are subscribed to pay as you go plan. You can check your subscription plan and credentials at api.pdftron.com
	    STATUS_SERVICE_DOWN,		///<Server is not responding. If the error persists contact pdftron support support@pdftron.com
	    STATUS_INVALID_OPERATION,	///<Unexpected internal server error. If the error persists contact pdftron support support@pdftron.com
	    STATUS_NUM					///<
	 };
	/**
	 ...
	 */
	static PDFNet::CloudErrorCode ConnectToCloud(const char* api_id, const char* api_secret, bool demo_mode = false); 
