...
TRN_API TRN_FDFDocCreateFromSDFDoc(TRN_SDFDoc sdfdoc, TRN_FDFDoc* result);
...
TRN_API TRN_FDFDocCreateFromStream (TRN_Filter stream, TRN_FDFDoc* result);
...
TRN_API TRN_FDFDocGetSDFDoc (TRN_FDFDoc doc, TRN_SDFDoc* result);
TRN_API TRN_FDFDocCreateFromXFDF(const TRN_UString file_name, TRN_FDFDoc* result);
TRN_API TRN_FDFDocSaveAsXFDF(TRN_FDFDoc doc, const TRN_UString file_name);
