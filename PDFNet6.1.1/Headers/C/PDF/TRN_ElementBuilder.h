...
#ifndef	  H_CPDFElementBuilder
#define	  H_CPDFElementBuilder
...
TRN_API TRN_ElementBuilderCreateTextRunUnsigned(TRN_ElementBuilder b, const TRN_UChar* text_data, TRN_UInt32 text_data_sz, TRN_Font font, double font_sz, TRN_Element* result);
...
TRN_API TRN_ElementBuilderCreateNewTextRunUnsigned(TRN_ElementBuilder b, const TRN_UChar* text_data, TRN_UInt32 text_data_sz, TRN_Element* result);
...
TRN_API TRN_ElementBuilderCreatePath(TRN_ElementBuilder b, const double* points, int point_count, const char* seg_types, int seg_types_count, TRN_Element* result);
...
TRN_API TRN_ElementBuilderCreateEllipse(TRN_ElementBuilder b, double cx, double cy, double rx, double ry, TRN_Element* result);
...
TRN_API TRN_ElementBuilderRect(TRN_ElementBuilder b, double cx, double cy, double rx, double ry);
