...
{
	REX(TRN_PDFDrawSetOverprint(mp_draw, (enum TRN_OverprintPreviewMode)op));	
}
...
inline void PDFDraw::SetPathHinting(bool enable_ph)
{
	REX(TRN_PDFDrawSetPathHinting(mp_draw,BToTB(enable_ph)));
}
...
inline void PDFDraw::SetImageSmoothing(bool smoothing_enabled)
{
	REX(TRN_PDFDrawSetImageSmoothing(mp_draw,BToTB(smoothing_enabled)));	
}
