...
inline void PDFDocViewPrefs::SetLayoutMode(PDFDocViewPrefs::PageLayout layout)
{
	REX(TRN_PDFDocViewPrefsSetLayoutMode(mp_prefs, (enum TRN_PDFDocViewPrefsPageLayout)layout));
}
