...
#if defined(__iOS__)
inline Highlights* Highlights::__Create(ptrdiff_t impl) {
	return new Highlights((TRN_Highlights)impl);
}

inline ptrdiff_t Highlights::__GetHandle() {
...
{
	REX(TRN_HighlightsCopyCtor(&mp_highlights, hlts.mp_highlights));
}
