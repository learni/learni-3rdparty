    ...
    static void AnnotationHighLevelAPI(PDFDoc doc) throws PDFNetException {
        ...
        for (PageIterator itr = doc.getPageIterator(); itr.hasNext();) {
            ...
            for (int i = 0; i < num_annots; ++i) {
                ...
                case Annot.e_Link: {
                    pdftron.PDF.Annots.Link link = new pdftron.PDF.Annots.Link(annot);
        ...
        // Create a hyperlink...
        pdftron.PDF.Annots.Link hyperlink = pdftron.PDF.Annots.Link.create(doc,
        ...
        pdftron.PDF.Annots.Link link = pdftron.PDF.Annots.Link.create(doc.getSDFDoc(),
                new Rect(85, 458, 503, 502),
                Action.createURI(doc, "http://www.pdftron.com"));// goto_page_3
        ...
        pdftron.PDF.Annots.FileAttachment file_attach = pdftron.PDF.Annots.FileAttachment.create(doc, new Rect(80, 280, 200, 320),
                Utils.getAssetTempFile(INPUT_PATH + "peppers.jpg").getAbsolutePath());
        first_page.annotPushBack(file_attach);

        pdftron.PDF.Annots.Circle circle = pdftron.PDF.Annots.Circle.create(doc, new Rect(10, 110, 100, 200));
        ...
        pdftron.PDF.Annots.Ink ink = pdftron.PDF.Annots.Ink.create(doc, new Rect(110, 10, 300, 200));
