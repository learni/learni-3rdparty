#ifndef   H_CPPSelection
#define   H_CPPSelection
...
namespace pdftron {
	...
	public:
		...
		*/
		 ...
		 */
		 ...
		 int Selection::GetQuads(const double* & quads) const;
		 void Selection::GetAsUnicode(UString& out_str) const;
	...
	{
		REX(TRN_PDFViewSelectionCreate(&mp_selection));
		REX(TRN_PDFViewSelectionAssign(&mp_selection,(TRN_PDFViewSelection*)&(s.mp_selection)));
	}
