...
#ifndef   H_CPPPDFPathData
#define   H_CPPPDFPathData
...
public:
	...
	enum PathSegmentType
	{
		...
		// A quadratic Bézier curve from the current point to (x,y) using (x1,y1) as
...
/// @cond PRIVATE_DOC
	...
	PathData(bool i, const std::vector<unsigned char>& o, const std::vector<double>& d) : is_def(i), oprs(o), pts(d) {}
#endif
/// @endcond
};
