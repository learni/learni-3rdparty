...
#ifndef	  H_CPDFElement
#define	  H_CPDFElement
...
TRN_API TRN_ElementGetPointCount(TRN_Element e, int* result);
...
TRN_API TRN_ElementSetPathPoints(TRN_Element e, const double* in_points, int count);
...
TRN_API TRN_ElementGetImageData(TRN_Element e, TRN_Filter* result);
...
TRN_API TRN_ElementSetTextData(TRN_Element e, const TRN_UChar* text_data, int text_data_size);
TRN_API TRN_ElementSetTextMatrix(TRN_Element e, TRN_Matrix2D* mtx);
