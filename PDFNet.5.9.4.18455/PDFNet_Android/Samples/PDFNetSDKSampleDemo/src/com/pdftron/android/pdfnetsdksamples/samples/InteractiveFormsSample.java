...
import pdftron.PDF.FieldIterator;
...
public class InteractiveFormsSample extends PDFNetSample {
    ...
    public void run(OutputListener outputListener) {
        ...
        try {
            ...
            pdftron.PDF.Annots.Widget annot1 = pdftron.PDF.Annots.Widget
                    .create(doc, new Rect(50, 550, 350, 600), emp_first_name);
            pdftron.PDF.Annots.Widget annot2 = pdftron.PDF.Annots.Widget
                    .create(doc, new Rect(50, 450, 350, 500), emp_last_name);

            // Create a check-box annotation
            pdftron.PDF.Annots.Widget annot3 = pdftron.PDF.Annots.Widget
            ...
            pdftron.PDF.Annots.Widget annot4 = pdftron.PDF.Annots.Widget
