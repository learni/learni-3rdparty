	...
	private void setUp(int color) {
		try {
			...
			*/
			...
			rlayout.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
			setView(rlayout);
			
			mColorPicker = new ColorPickerView(mContext);
			mColorPicker.setId(1);
			RelativeLayout.LayoutParams rp = new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
			...
			rp = new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, margin*4);
			...
			LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(0, LayoutParams.FILL_PARENT, 0.5f);
			...
			RelativeLayout.LayoutParams rp4 = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.FILL_PARENT);
