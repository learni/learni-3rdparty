...
public: 
	...
	* @return The annotation's time and date. If the annotation has no associated date
	...
	* @param The annotation's time and date. 
	*/
	...
	* 
	*/
	void SetStructParent(const int keyval);//The value can be set, should be limited. 
