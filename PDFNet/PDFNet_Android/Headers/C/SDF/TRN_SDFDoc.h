...
#include <C/Common/TRN_Types.h>
	...
	TRN_API TRN_SDFDocCreateFromFilter(TRN_Filter stream,TRN_SDFDoc* result);
	...
	TRN_API TRN_SDFDocInitStdSecurityHandler(TRN_SDFDoc doc, 
		const char* password, int password_sz, TRN_Bool* result);
	...
	TRN_API TRN_SDFDocGetSecurityHandler(TRN_SDFDoc doc, TRN_SecurityHandler* result);

	TRN_API TRN_SDFDocSetSecurityHandler(TRN_SDFDoc doc,TRN_SecurityHandler handler);
	...
	TRN_API TRN_SDFDocCreateIndirectString(TRN_SDFDoc doc, const TRN_UChar* value, TRN_UInt32 size, TRN_Obj* result);
	TRN_API TRN_SDFDocCreateIndirectStringFromUString(TRN_SDFDoc doc, const TRN_UString str, TRN_Obj* result);
	TRN_API TRN_SDFDocCreateIndirectStreamFromFilter(TRN_SDFDoc doc, TRN_FilterReader data, TRN_Filter filter_chain, TRN_Obj* result);
	TRN_API TRN_SDFDocCreateIndirectStream(TRN_SDFDoc doc, const char* data, const TRN_Size data_size, TRN_Filter filter_chain, TRN_Obj* result);
