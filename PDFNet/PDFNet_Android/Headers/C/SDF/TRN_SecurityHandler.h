...
#ifndef   H_CSDFSecurityHandler
#define   H_CSDFSecurityHandler
...
enum TRN_SecurityHandlerAlgorithmType {
	e_StdSecurityHandler_RC4_40 = 1,      
	e_StdSecurityHandler_RC4_128,           
	e_StdSecurityHandler_AES             
};
...
TRN_API TRN_SecurityHandlerChangeUserPassword(TRN_SecurityHandler sh,const char* password);
TRN_API TRN_SecurityHandlerChangeUserPasswordNonAscii(TRN_SecurityHandler sh,const char* password, size_t pwd_length );
TRN_API TRN_SecurityHandlerGetUserPassword(TRN_SecurityHandler sh, const char** result);
TRN_API TRN_SecurityHandlerGetUserPasswordSize(TRN_SecurityHandler sh, TRN_UInt32* result);
TRN_API TRN_SecurityHandlerChangeMasterPassword(TRN_SecurityHandler sh, const char* password);
TRN_API TRN_SecurityHandlerChangeMasterPasswordNonAscii(TRN_SecurityHandler sh,const char* password, size_t pwd_length );
TRN_API TRN_SecurityHandlerGetMasterPassword(TRN_SecurityHandler sh, const char** result);
TRN_API TRN_SecurityHandlerGetMasterPasswordSize(TRN_SecurityHandler sh, TRN_UInt32* result);
...
TRN_API TRN_SecurityHandlerInitPassword(TRN_SecurityHandler sh, const char* password);
TRN_API TRN_SecurityHandlerInitPasswordNonAscii(TRN_SecurityHandler sh, const char* password, size_t pwd_length);
...
TRN_API TRN_SecurityHandlerAuthorize(TRN_SecurityHandler sh, enum TRN_SecurityHandlerPermission req_opr, TRN_Bool* result);
