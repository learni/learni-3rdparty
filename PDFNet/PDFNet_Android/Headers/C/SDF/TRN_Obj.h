...
TRN_API TRN_ObjSetString(TRN_Obj o, const TRN_UChar* value, TRN_Size size);
...
TRN_API TRN_ObjSetStreamDataWithFilter( TRN_Obj obj, const char* data, const size_t data_size, TRN_Filter filter_chain );
TRN_API TRN_ObjGetRawStream (const TRN_Obj o, TRN_Bool decrypt, TRN_Filter* result);
TRN_API TRN_ObjGetDecodedStream (const TRN_Obj o, TRN_Filter* result);
