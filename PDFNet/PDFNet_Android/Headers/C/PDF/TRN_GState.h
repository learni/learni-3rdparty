...
TRN_API TRN_GStateGetDashes(const TRN_GState gs, double* dashes, int* ret_dashes_sz);
...
TRN_API TRN_GStateSetDashPattern(TRN_GState gs,const double* dash_array, int dash_array_sz, double phase);
