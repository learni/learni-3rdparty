...
/**
 * In this simple example, it only searches the "/mnt" directory and displays
 * all the PDF files found.
 */
public class FileOpenDlg extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FileAdapter(this, R.layout.file_entry, inflater, mFiles);
    ...
    private void openFile(File file)
    {
    	if ( file == null ) {
	    	...
	    	intent1.putExtra("com.pdftron.pdfnet.demo.pdfdraw.FileOpenData", str);
...
class FileAdapter extends ArrayAdapter<File> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            View v = convertView;
            if (v == null) {
                v = mInflater.inflate(R.layout.file_entry, null);
            }
