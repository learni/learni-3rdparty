...
class FreeTextCreate extends Tool {
    ...
    public boolean onUp(MotionEvent e, int prior_event_type) {
        ...
        mPageNum = mPDFView.getPageNumberFromClientPt(e.getX(), e.getY());
        if ( mPageNum < 1 ) {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    if (!TextUtils.isEmpty(d.getNote())) {
                        ...
                        // Get the annotation's content stream and iterate through elements to union their bounding boxes
                        ...
                        pt1 = mPDFView.convPagePtToClientPt(x1, y1, mPageNum);
                        pt2 = mPDFView.convPagePtToClientPt(x2, y2, mPageNum);
                        ...
                        pt1 = mPDFView.convClientPtToPagePt(x1, y1, mPageNum);
                        pt2 = mPDFView.convClientPtToPagePt(x2, y2, mPageNum);
    ...
    private pdftron.PDF.Rect getTextBBox() {
        ...
        pts1 = mPDFView.convClientPtToPagePt(mPoint.x-mPDFView.getScrollX(), mPoint.y-mPDFView.getScrollY(), mPageNum);
        pts2 = mPDFView.convClientPtToPagePt(mPoint.x + 100 -mPDFView.getScrollX(), mPoint.y + 100 -mPDFView.getScrollY(), mPageNum);
    ...
    private pdftron.PDF.Rect getTextBBoxOnPage() {
        ...
        double [] pt1 = new double[2];
        double [] pt2 = new double[2];
        pt1 = mPDFView.convClientPtToPagePt(pt1c[0], pt1c[1], mPageNum);
        pt2 = mPDFView.convClientPtToPagePt(pt2c[0], pt2c[1], mPageNum);
